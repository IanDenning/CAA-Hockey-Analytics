...
Forwards: TOI/GP + Total Points/60 - adj. R² = 0.6584
Defensemen: TOI/GP + xGF/60 - adj. R² = 0.6868
...
Note
Data files and generated outputs are excluded from this repository. Only the methodology and code are public.
