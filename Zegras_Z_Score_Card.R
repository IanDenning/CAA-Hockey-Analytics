...
Zegras_Trevor_Z_Card <- Forwards_zScores_Master

# ============================================================
# PLAYER CONFIG — only edit this block per player
# ============================================================

player_name     <- "Zegras, Trevor"
player_team     <- "ANA/PHI"
player_pos      <- "C/LW"
player_number   <- 46
player_age      <- 25
...
headshot_path   <- "/Users/iandenning/Downloads/Zegras_Trevor.png"
...
p_row <- Zegras_Trevor_Z_Card %>% filter(Player == player_name)
